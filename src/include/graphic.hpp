...
class Graphic {
 public:
    ...
    void draw_interface(int32_t mines, uint32_t time, std::string state, sf::Vector2f mouse);
    void draw_score(const std::string name, const int16_t score, const unsigned pos,
